...
class HBM2_64B : public IDRAM, public Implementation {
  RAMULATOR_REGISTER_IMPLEMENTATION(IDRAM, HBM2_64B, "HBM2_64B", "HBM2_64B Device Model")
  ...
  public:
    ...
    inline static const std::map<std::string, std::vector<int>> timing_presets = {
      ...
      {"HBM2_2Gbps",    {2000,   4,   7,    7,      7,   7,   17,  19,   8,    4,     6,    2,    2,      4,     2,     3,     3,     4,    3,    15,   -1,   160,   3900,     -1,      8,   1000}},
      {"HBM2_2.5Gbps",  {2400,   4,   9,    9,      9,   9,   21,  23,  10,    6,     8,    3,    2,      4,     3,     4,     4,     5,    4,    19,   -1,   193,   4680,     -1,     10,    833}},
  ...
  public:
    struct Node : public DRAMNodeBase<HBM2_64B> {
      Node(HBM2_64B* dram, Node* parent, int level, int id) : DRAMNodeBase<HBM2_64B>(dram, parent, level, id) {};
    };
  ...
  private:
    ...
    void set_actions() {
      ...
      // Channel Actions
      m_actions[m_levels["channel"]][m_commands["PREA"]] = Lambdas::Action::Channel::PREab<HBM2_64B>;

      // Bank actions
      m_actions[m_levels["bank"]][m_commands["ACT"]] = Lambdas::Action::Bank::ACT<HBM2_64B>;
      m_actions[m_levels["bank"]][m_commands["PRE"]] = Lambdas::Action::Bank::PRE<HBM2_64B>;
      m_actions[m_levels["bank"]][m_commands["RDA"]] = Lambdas::Action::Bank::PRE<HBM2_64B>;
      m_actions[m_levels["bank"]][m_commands["WRA"]] = Lambdas::Action::Bank::PRE<HBM2_64B>;
    };
    ...
    void set_preqs() {
      ...
      // Channel Actions
      m_preqs[m_levels["channel"]][m_commands["REFab"]] = Lambdas::Preq::Channel::RequireAllBanksClosed<HBM2_64B>;

      // Bank actions
      m_preqs[m_levels["bank"]][m_commands["REFsb"]] = Lambdas::Preq::Bank::RequireBankClosed<HBM2_64B>;
      m_preqs[m_levels["bank"]][m_commands["RD"]] = Lambdas::Preq::Bank::RequireRowOpen<HBM2_64B>;
      m_preqs[m_levels["bank"]][m_commands["WR"]] = Lambdas::Preq::Bank::RequireRowOpen<HBM2_64B>;
    };

    void set_rowhits() {
      m_rowhits.resize(m_levels.size(), std::vector<RowhitFunc_t<Node>>(m_commands.size()));

      m_rowhits[m_levels["bank"]][m_commands["RD"]] = Lambdas::RowHit::Bank::RDWR<HBM2_64B>;
      m_rowhits[m_levels["bank"]][m_commands["WR"]] = Lambdas::RowHit::Bank::RDWR<HBM2_64B>;
    }
    ...
    void set_rowopens() {
      ...
      m_rowopens[m_levels["bank"]][m_commands["RD"]] = Lambdas::RowOpen::Bank::RDWR<HBM2_64B>;
      m_rowopens[m_levels["bank"]][m_commands["WR"]] = Lambdas::RowOpen::Bank::RDWR<HBM2_64B>;
    }

#include "CholeskyBlockBaselineModel.h"
#include "CholeskyBlockBaselineOp.h"
void CholeskyBlockBaselineModel::initialize_model(
  ...
  auto op = std::make_unique<CholeskyBlockBaselineOp>(_config, this,
      name_gen(get_name(), "CholeskyBlockBaselineOp"), attrs, 0);

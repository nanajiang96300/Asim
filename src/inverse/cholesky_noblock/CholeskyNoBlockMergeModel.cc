#include "CholeskyNoBlockMergeModel.h"
#include "CholeskyNoBlockMergeOp.h"

void CholeskyNoBlockMergeModel::initialize_model(
  ...
  auto op = std::make_unique<CholeskyNoBlockMergeOp>(_config, this,
      name_gen(get_name(), "CholeskyNoBlockMergeOp"), attrs, 0);

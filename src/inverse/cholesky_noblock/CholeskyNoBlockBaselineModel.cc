#include "CholeskyNoBlockBaselineModel.h"
#include "CholeskyNoBlockBaselineOp.h"

void CholeskyNoBlockBaselineModel::initialize_model(
  ...
  auto op = std::make_unique<CholeskyNoBlockBaselineOp>(_config, this,
      name_gen(get_name(), "CholeskyNoBlockBaselineOp"), attrs, 0);

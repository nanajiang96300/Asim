#include "LDLNoBlockBaselineModel.h"
#include "LDLNoBlockBaselineOp.h"

void LDLNoBlockBaselineModel::initialize_model(
  ...
  auto op = std::make_unique<LDLNoBlockBaselineOp>(_config, this,
      name_gen(get_name(), "LDLNoBlockBaselineOp"), attrs, 0);

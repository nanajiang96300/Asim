"""Cholesky Block v3 — per-operator verification."""
import json, numpy as np, sys, os
sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
from uobs_dag_executor import prim_gemm, prim_diag_add, prim_cholesky, prim_trsm, _cplx_fp16

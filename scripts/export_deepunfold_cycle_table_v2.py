...
def main() -> None:
    parser = argparse.ArgumentParser(description="Export DeepUnfold detailed cycle table.")
    parser.add_argument("--trace", required=True)
    parser.add_argument("--output", required=True)
    parser.add_argument("--mode", default="auto", choices=["auto", "deepunfold_du", "deepunfold_duo"])

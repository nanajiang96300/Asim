...
| C5 | `scripts/verify/bri_v3.py:25` | BRI DAG vs ref 数学不匹配 | ✅ 已文档化 (68bb7206) |
...
| L4 | `NewtonSchulzBaselineOp.cc` | 使用未文档化的 barrier type 2 | ✅ 已文档化 (68bb7206) |
| L5 | `BlockRichardsonBaselineOp.cc` | 非标准 barrier pattern | ✅ 已文档化 (68bb7206) |
